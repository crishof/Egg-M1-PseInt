...
SubProceso menu(opMenu)
	...
	Segun opMenu Hacer
		...
		"1":
			calcularMuro(alto,largo,espesor,volumen,superficie)
		"2":
			calcularViga(alto,largo,espesor,volumen,superficie)
		"3":
			calcularColumna(alto,largo,espesor,volumen,superficie)
		"4":
			calcularContrapiso(alto,largo,espesor,volumen,superficie)
		"5":
			calcularTecho(alto,largo,espesor,volumen,superficie)
		"6":
			calcularPiso(alto,largo,espesor,volumen,superficie)
		"7":
			calcularPintura(alto,largo,espesor,volumen,superficie)
		"8":
			calcularIluminacion(alto,largo,espesor,volumen,superficie)
		"9":
...
SubProceso calcularVolumen(alto,largo,espesor,volumen Por Referencia)
...
SubProceso calcularMuro(alto,largo,espesor,volumen Por Referencia,superficie Por Referencia)
...
SubProceso calcularViga(alto,largo,espesor,volumen Por Referencia,superficie Por Referencia)
...
//	Debemos mostrar al usuario la cantidad de materiales necesaria.
SubProceso calcularColumna(alto,largo,espesor,volumen Por Referencia,superficie Por Referencia)
	Definir cemento, arena, piedra, hierrodel10, hierrodel4 Como Real
	...
	Escribir arena," m3 de arena "
	Escribir piedra," m3 de piedra "
	Escribir hierrodel10, " m de hierro del 10 "
	Escribir hierrodel4, " m de hierro del 4 "
FinSubProceso
////	subprograma calcularContrapisos
//	Nos debe pedir espesor, alto y largo del contrapiso a calcular.
//	Por metro cúbico de contrapiso se necesita: 105 kg de cemento, 0.45 m3 de arena y 0.9 m3 de piedra.
//	Debemos mostrar al usuario la cantidad de materiales necesaria.
SubProceso calcularContrapiso(alto,largo,espesor,volumen Por Referencia,superficie Por Referencia)
	Definir cemento, arena, piedra como real
	calcularVolumen(alto,largo,espesor,volumen)
	cemento = volumen * 105
	arena = volumen * 0.45
	piedra = volumen * 0.9
...
//	Nos debe pedir espesor, alto y largo del techo a calcular.
...
//	Debemos mostrar al usuario la cantidad de materiales necesaria.
SubProceso calcularTecho(alto,largo,espesor,volumen Por Referencia,superficie Por Referencia)
...
//	Nos debe pedir alto y largo del paño de piso a colocar. Teniendo esos datos se debe calcular la
//	superficie y añadirle un 10% extra por recortes
//	Mostrar el resultado en m2
SubProceso calcularPiso(alto,largo,espesor,volumen Por Referencia,superficie Por Referencia)
	calcularSuperficie(largo,alto,superficie)
...
SubProceso calcularPintura(alto,largo,espesor,volumen Por Referencia,superficie Por Referencia)
...
SubProceso calcularIluminacion(alto,largo,espesor,volumen Por Referencia,superficie Por Referencia)
